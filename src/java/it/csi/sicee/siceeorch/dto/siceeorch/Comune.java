...
////{PROTECTED REGION ID(R-127343421) ENABLED START////}
/**
 * Inserire qui la documentazione della classe Comune.
 * Consigli:
 * <ul>
...
public class Comune implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1231633963) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R474380892) ENABLED START////}
	/**
	...
	/**
	 * Imposta il valore della property [codCatasto]
	 * @param val il valore da impostare
	 * @generated
	 */
	...
	////{PROTECTED REGION ID(R-1976531090) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo codCatasto. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R657319646) ENABLED START////}
	/**
	...
	/**
	 * Imposta il valore della property [nomeProv]
	 * @param val il valore da impostare
	 * @generated
	 */
	...
	////{PROTECTED REGION ID(R1169163237) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo nomeProv. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	/*PROTECTED REGION ID(R-1557774266) ENABLED START*/
