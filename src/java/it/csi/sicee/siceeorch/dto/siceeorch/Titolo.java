...
////{PROTECTED REGION ID(R354013739) ENABLED START////}
/**
...
public class Titolo implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1887225276) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-783932071) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo idTitolo. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	/*PROTECTED REGION ID(R1437288926) ENABLED START*/
