...
////{PROTECTED REGION ID(R-520954955) ENABLED START////}
/**
 * Inserire qui la documentazione della classe Provincia.
 * Consigli:
 * <ul>
...
public class Provincia implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-2052125277) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R808953934) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1115288402) ENABLED START*/
