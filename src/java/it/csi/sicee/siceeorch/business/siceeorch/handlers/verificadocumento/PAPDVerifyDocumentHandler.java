...
public class PAPDVerifyDocumentHandler extends PAPDCallBaseHandler {
	...
	/**
	 * Esegue la chiamata all'operazione verifyDocument del servizio INDEX_SECURITY
	...
	public void eseguiFunctionHandler(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		try {
			...
			LOGGER.debug("[PAPDVerifyDocumentHandler::eseguiFunctionHandler]-richiamo del metodo  " + "verifyDocument");
			it.doqui.index.ecmengine.dto.engine.security.VerifyReport result = pd.verifyDocument(slot_node,
