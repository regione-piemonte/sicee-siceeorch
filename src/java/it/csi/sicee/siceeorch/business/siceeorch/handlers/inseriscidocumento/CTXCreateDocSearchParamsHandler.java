...
/*PROTECTED REGION ID(R2076409602) ENABLED START*/
...
public class CTXCreateDocSearchParamsHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		...
		/*PROTECTED REGION ID(R482324381) ENABLED START*/
		...
		outVal.setLimit(1);
		String path = "/app:company_home/cm:sicee/cm:" + certificatore + "/cm:" + anno + "/cm:" + numero + "/cm:"
				+ slot_docIns.getNome();
