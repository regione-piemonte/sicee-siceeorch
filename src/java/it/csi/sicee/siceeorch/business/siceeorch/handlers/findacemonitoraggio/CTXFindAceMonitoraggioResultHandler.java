...
/*PROTECTED REGION ID(R-273393656) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
import java.util.ArrayList;
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [findAceMonitoraggioResult].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXFindAceMonitoraggioResultHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXFindAceMonitoraggioResultHandler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R652867415) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXFindAceMonitoraggioResultHandler::getTransformedObject]-END ");
		return outVal;
	}
}
