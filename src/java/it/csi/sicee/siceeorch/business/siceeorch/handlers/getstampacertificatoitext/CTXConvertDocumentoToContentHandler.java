...
/*PROTECTED REGION ID(R-1373409) ENABLED START*/
...
public class CTXConvertDocumentoToContentHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		...
		/*PROTECTED REGION ID(R495560480) ENABLED START*/
		/// inserire qui la logica di trasformazione

		if (getLogger(null).isDebugEnabled())
			getLogger(null).debug("Stampo slot_docRic.getNome(): " + slot_docRic.getNome());
