 ...
 * @generated
 */
public class PAPDUpdateContentDocumentHandler extends PAPDCallBaseHandler {
	...
	public void eseguiFunctionHandler(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		LOGGER.debug("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-START ");
		try {
			...
			LOGGER.debug("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-binding parametri ");
			// slot: nodeUid
			it.doqui.index.ecmengine.dto.Node slot_nodeUid = (it.doqui.index.ecmengine.dto.Node) DataSlotHelper
					.getDataSlotValue("SLOT_nodeUid", ps);
			...
			LOGGER.debug("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-richiamo del metodo  "
					+ "updateContentData");
			// binding dei parametri e richiamo del servizio 

			LOGGER.debug("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-richiamo del metodo  "
					+ "updateContentData");
			pd.updateContentData(slot_nodeUid, slot_contentIns, slot_operationContextIns);
			LOGGER.debug("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-richiamo ok  ");

		} catch (Exception e) {
			// l'eccezione viene inserita nel contesto per essere processata successivamente
			DataSlotHelper.setLastError(e, ps);
			LOGGER.error("[PAPDUpdateContentDocumentHandler::eseguiFunctionHandler]-richiamo ko, inserimento eccezione "
