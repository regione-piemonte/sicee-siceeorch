...
/*PROTECTED REGION ID(R1685211026) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertDocumentToNode].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertDocumentToNodeHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXConvertDocumentToNodeHandler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R1240070413) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXConvertDocumentToNodeHandler::getTransformedObject]-END ");
		return outVal;
	}
}
