...
/*PROTECTED REGION ID(R-2014150044) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertDocumentoToSearchParamsParentFolderLevel2].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertDocumentoToSearchParamsParentFolderLevel2Handler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null)
				.debug("[CTXConvertDocumentoToSearchParamsParentFolderLevel2Handler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R-1770973061) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null)
				.debug("[CTXConvertDocumentoToSearchParamsParentFolderLevel2Handler::getTransformedObject]-END ");
		return outVal;
	}
}
