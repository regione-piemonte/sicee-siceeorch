 ...
 * @generated
 */
public class PAPDGetUidParentFolderLevel2Handler extends PAPDCallBaseHandler {
	...
	public void eseguiFunctionHandler(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		LOGGER.debug("[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-START ");
		try {
			...
			LOGGER.debug("[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-binding parametri ");
			...
			LOGGER.debug(
					"[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-richiamo del metodo  " + "getUid");
			it.doqui.index.ecmengine.dto.Node result = pd.getUid(slot_searchParamsIns, slot_operationContextIns);

			LOGGER.debug("[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-richiamo ok  ");

			/// inserimento risultato nello slot apposito (SLOT_nodeFolderLevel2)

			LOGGER.debug(
					"[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-inserimento del risultato nello slot   "
			...
			LOGGER.error(
					"[PAPDGetUidParentFolderLevel2Handler::eseguiFunctionHandler]-richiamo ko, inserimento eccezione "
