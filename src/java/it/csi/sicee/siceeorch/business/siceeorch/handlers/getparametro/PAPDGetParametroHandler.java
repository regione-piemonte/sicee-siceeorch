package it.csi.sicee.siceeorch.business.siceeorch.handlers.getparametro;
 ...
 * @generated
 */
public class PAPDGetParametroHandler extends PAPDCallBaseHandler {
	...
	public void eseguiFunctionHandler(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		LOGGER.debug("[PAPDGetParametroHandler::eseguiFunctionHandler]-START ");
		try {
			...
			LOGGER.debug("[PAPDGetParametroHandler::eseguiFunctionHandler]-binding parametri ");
			// slot: code
			...
			LOGGER.debug("[PAPDGetParametroHandler::eseguiFunctionHandler]-richiamo del metodo  " + "getParametro");
			java.lang.String result = pd.getParametro(slot_code);

			LOGGER.debug("[PAPDGetParametroHandler::eseguiFunctionHandler]-richiamo ok  ");

			/// inserimento risultato nello slot apposito (SLOT_value)

			LOGGER.debug("[PAPDGetParametroHandler::eseguiFunctionHandler]-inserimento del risultato nello slot   "
					+ "SLOT_value");
			...
			LOGGER.error("[PAPDGetParametroHandler::eseguiFunctionHandler]-richiamo ko, inserimento eccezione " + e
