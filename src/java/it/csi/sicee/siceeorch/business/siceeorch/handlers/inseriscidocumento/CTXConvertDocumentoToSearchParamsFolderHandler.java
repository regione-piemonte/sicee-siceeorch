...
/*PROTECTED REGION ID(R766467532) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertDocumentoToSearchParamsFolder].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertDocumentoToSearchParamsFolderHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXConvertDocumentoToSearchParamsFolderHandler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R-1471174125) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXConvertDocumentoToSearchParamsFolderHandler::getTransformedObject]-END ");
		return outVal;
	}
}
