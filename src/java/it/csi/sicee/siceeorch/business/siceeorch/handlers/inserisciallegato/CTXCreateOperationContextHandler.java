...
/*PROTECTED REGION ID(R931126537) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
import it.csi.sicee.siceeorch.business.util.Constants;
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [createOperationContext].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXCreateOperationContextHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXCreateOperationContextHandler::getTransformedObject]-START ");
		it.doqui.index.ecmengine.dto.OperationContext outVal = (it.doqui.index.ecmengine.dto.OperationContext) (inputs
				.get(_outputSlotName));

		/// valore degli input slot

		/*PROTECTED REGION ID(R-661712266) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXCreateOperationContextHandler::getTransformedObject]-END ");
		return outVal;
	}
}
