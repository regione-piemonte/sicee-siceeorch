 ...
 * - servizio [SICEESRV]
 * - operation [findUidFotoPrincipaleApe]
 * il servizio verra' richiamato tramite configurazione locale della PD
 * @generated
 */
public class PAPDGetUidFotoPrincipaleApeHandler extends PAPDCallBaseHandler {
	...
	/**
	 * Esegue la chiamata all'operazione findUidFotoPrincipaleApe del servizio SICEESRV
	...
	public void eseguiFunctionHandler(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
		...
		LOGGER.debug("[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-START ");
		try {
			...
			LOGGER.debug("[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-binding parametri ");
			...
			LOGGER.debug("[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-richiamo del metodo  "
					+ "findUidFotoPrincipaleApe");
			java.lang.String result = pd.findUidFotoPrincipaleApe(slot_numCertificatore, slot_progrCertificato,
					slot_annoCertificato);

			LOGGER.debug("[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-richiamo ok  ");

			/// inserimento risultato nello slot apposito (SLOT_uidFoto)

			LOGGER.debug(
					"[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-inserimento del risultato nello slot   "
							+ "SLOT_uidFoto");
			...
			LOGGER.error(
					"[PAPDGetUidFotoPrincipaleApeHandler::eseguiFunctionHandler]-richiamo ko, inserimento eccezione "
