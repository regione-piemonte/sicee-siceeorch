...
/*PROTECTED REGION ID(R-1720747037) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertDocumentoToSearchParamsParentFolderLevel1].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertDocumentoToSearchParamsParentFolderLevel1Handler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null)
				.debug("[CTXConvertDocumentoToSearchParamsParentFolderLevel1Handler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R-1265414436) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null)
				.debug("[CTXConvertDocumentoToSearchParamsParentFolderLevel1Handler::getTransformedObject]-END ");
		return outVal;
	}
}
