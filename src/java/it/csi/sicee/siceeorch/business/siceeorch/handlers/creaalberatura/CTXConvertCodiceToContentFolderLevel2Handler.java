...
/*PROTECTED REGION ID(R-716256777) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
import it.doqui.index.ecmengine.dto.engine.management.Property;
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertCodiceToContentFolderLevel2].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertCodiceToContentFolderLevel2Handler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXConvertCodiceToContentFolderLevel2Handler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R-190987448) ENABLED START*/
		/// inserire qui la logica di trasformazione

		String name = slot_anno;
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXConvertCodiceToContentFolderLevel2Handler::getTransformedObject]-END ");
		return outVal;
	}
}
