...
/*PROTECTED REGION ID(R1241069201) ENABLED START*/
...
/**
 * Implementazione della custom transformation [convertDocumentoToContentFolderLevel2].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertDocumentoToContentFolderLevel2Handler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXConvertDocumentoToContentFolderLevel2Handler::getTransformedObject]-START ");
		...
		/*PROTECTED REGION ID(R356575726) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXConvertDocumentoToContentFolderLevel2Handler::getTransformedObject]-END ");
		return outVal;
	}
}
