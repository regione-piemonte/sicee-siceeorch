...
/*PROTECTED REGION ID(R-2071802990) ENABLED START*/
/// inserire qui eventuali import aggiuntive.
import it.csi.sicee.siceeorch.business.util.Constants;
/*PROTECTED REGION END*/

/**
 * Implementazione della custom transformation [convertCodiceToOperationContext].
 * la logica della trasformazione e' codificata in java nel metodo:
 * getTransformedObject() 
 * @generated
 */
public class CTXConvertCodiceToOperationContextHandler extends CustomTransformBaseHandler {
	...
	public Object getTransformedObject(Map<String, Object> inputs) {
		getLogger(null).debug("[CTXConvertCodiceToOperationContextHandler::getTransformedObject]-START ");
		it.doqui.index.ecmengine.dto.OperationContext outVal = (it.doqui.index.ecmengine.dto.OperationContext) (inputs
				.get(_outputSlotName));

		/// valore degli input slot

		/*PROTECTED REGION ID(R736752909) ENABLED START*/
		...
		/*PROTECTED REGION END*/
		getLogger(null).debug("[CTXConvertCodiceToOperationContextHandler::getTransformedObject]-END ");
		return outVal;
	}
}
