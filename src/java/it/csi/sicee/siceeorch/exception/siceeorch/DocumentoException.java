...
////{PROTECTED REGION ID(R-1869459213) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione DocumentoException.
 * Consigli:
 * <ul>
...
public class DocumentoException extends UserException {
	 ...
	 * @generated
	 */
	public DocumentoException(String msg, String nestedExcClassName, String nestedExcMessage,
	 ...
	 * @generated
	 */
	public DocumentoException(String msg, Throwable nested) {
		super(msg, nested);
	}
